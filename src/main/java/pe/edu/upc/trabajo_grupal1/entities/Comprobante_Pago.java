...
public class Comprobante_Pago {
    ...
    public Comprobante_Pago(int idComprobante_Pago, String tipoComprobante, float montototal, float preciounitario, LocalDate fecha, String razonsocial, Cliente cliente, Carrito_Compras carritocompras) {
